...
<h3>Go Further</h3>
<ul>
 	<li>Experiment with Flexbox and Grid to create as many different layouts as you can</li>
 	<li>Try creating a robust layout that uses CSS Gird with a FLexbox fallback</li>
...
<ul>
 	...
 	<li>A Semantic Grid (w/ one half, one third, one fourth columns, etc)</li>
 	<li><a href="https://codepen.io/kccnma/pen/bjPvqZ?editors=1100">A Flexible Grid</a> (w/ no preset column classes)</li>
</ul>
</li>
</ul>
</li>
